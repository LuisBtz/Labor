...
const Contact = () => {
  ...
  return (
    <Layout>
      <Seo title={data.sanityContact.seo.es && data.sanityContact.seo.es.titleSeo } description={data.sanityContact.seo.es && data.sanityContact.seo.es.pageDescription } />
      <Team>
